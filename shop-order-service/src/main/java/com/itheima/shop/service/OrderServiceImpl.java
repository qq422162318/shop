...
public class OrderServiceImpl implements IOrderService {
    ...
    public Result confirmOrder(TradeOrder order) {
        ...
        try {
            ...
            //1.确认订单失败,发送消息
            System.out.println("确认订单失败,发送消息");
    ...
    private Long savePreOrder(TradeOrder order) {
        ...
        System.out.println(order.getOrderAmount()+","+orderAmount);
    ...
    private void checkOrder(TradeOrder order) {
        ...
        //4.校验商品单价是否合法
        System.out.println("order"+order.getGoodsPrice()+"::"+"goods"+goods.getGoodsPrice());
        if (order.getGoodsPrice().compareTo(goods.getGoodsPrice()) != 0) {
            System.out.println(ShopCode.SHOP_GOODS_PRICE_INVALID);
            CastException.cast(ShopCode.SHOP_GOODS_PRICE_INVALID);

        }
        System.out.println("order"+order.getGoodsNumber()+"::"+"goods"+goods.getGoodsNumber());
        //5.校验订单商品数量是否合法
